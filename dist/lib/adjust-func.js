...
exports.intersect = function () {
    ...
    return warn.apply(void 0, ['建议使用_.intersection 替换 mu.intersect', _.intersection].concat(values));
};
exports.union = function () {
    ...
    return warn.apply(void 0, ['建议使用_.union 替换 mu.union', _.union].concat(values));
};
