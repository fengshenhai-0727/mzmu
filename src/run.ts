...
export function __empty(val: any, trueFunc: SoFunc, falseFunc: SoFunc = __noop) {
 ...
 * // => 'def'
 */
export function __ifempty(val: any, trueValue: Value, falseValue?: Value) {
 ...
 */
export function __ifnvl(val: any, trueValue: Value, falseValue?: Value): any {
    falseValue = __isNil(falseValue) ? val : falseValue;
 ...
 * @private
 */
export function __if(val: any, trueFunc: SoFunc, falseFunc: SoFunc = __noop) {
 ...
 */
export function __run(val: any, trueFunc?: SoFunc, falseFunc?: SoFunc) {
