 ...
 * // => "江山如此多娇, 引无数英雄竞折腰"
 */
export function __stringFormat(str, format) {
...
export function __numberFormat(num, options) {
...
export function __dateFormat(date, format) {
    let mt = moment(date);
 ...
 * // -> "1236.5‰"
 */
export function __format(value, format, dateLike = false) {
...
export function __deepDecodeURIComponent(str) {
    __each(str.split('%'), () => {
        str = decodeURIComponent(str);
    });
    return str;
}
export const __leftpad = (str, length, symbol = '0') => {
